...
Process{
	Write-Output $pgPassword
	Install-Postgres -User $pgUser -Password $pgPassword -InstallerUrl $pgKitSource -InstallPath $pgInstallPath -DataPath $pgDataPath -Locale $pgLocale -Port $pgPort-ServiceName $pgServiceName
}
END{
}
